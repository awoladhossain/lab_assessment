                ...
                <div className="_layout_middle_inner">
                      ...
                      <div className="_feed_inner_text_area_bottom">
                        ...
                        <div className="d-flex align-items-center gap-3">
                          <select
                            ...
                            onChange={(e) =>
                              setNewPostVisibility(e.target.value as 'PUBLIC' | 'PRIVATE')
                            }
                          ...
                          >
                            <option value="PUBLIC" className="text-dark bg-white">
                              🌎 Public
                            </option>
                            <option value="PRIVATE" className="text-dark bg-white">
                              🔒 Private
                            </option>
                          </select>
                  ...
                  {filteredPosts.length === 0 ? (
                    ...
                    filteredPosts.map((post) => {
                      const isPostLiked =
                        post.isLiked || post.postLikes?.some((like) => like.userId === user.id);
                        ...
                        >
                          <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
                            <div className="_feed_inner_timeline_post_top">
                              ...
                              >
                                <div className="_feed_timeline_post_dropdown">
                                  <button
                                    onClick={() =>
                                      setOpenPostDropdownId(
                                        openPostDropdownId === post.id ? null : post.id,
                                      )
                                    }
                                ...
                                {/* Dropdown menu */}
                                <div
                                  className={`_feed_timeline_dropdown _timeline_dropdown ${openPostDropdownId === post.id ? 'show' : ''}`}
                                >
                            ...
                            {editingPostId === post.id ? (
                              ...
                              <>
                                <h4 className="_feed_inner_timeline_post_title mt-3">
                                  {post.text}
                                </h4>
                                {post.imageUrl && (
                                  <div className="_feed_inner_timeline_image">
                                    <img
                                      ...
                                      alt=""
                                      className="_time_img img-fluid rounded"
                                    />
                                  </div>
                                )}
                              </>
                          ...
                          <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26 d-flex align-items-center justify-content-between mt-3">
                            ...
                            >
                              ...
                              />
                              <p className="_feed_inner_timeline_total_reacts_para ms-1 mb-0">
                                {postLikesCount}
                              </p>

                              {/* Hover tooltip for Liked users */}
                              {hoveredLikesKey === `post_${post.id}` &&
                                post.likedBy &&
                            ...
                            <div className="_timline_comment_main">
                              {(post.comments?.filter((c) => !c.parentId) || []).map((comment) => {
                                const isCommentLiked =
                                  comment.isLiked ||
                                  comment.commentLikes?.some((l) => l.userId === user.id);
                                const commentLikesCount =
                                  comment.likesCount ?? comment.commentLikes?.length ?? 0;

                                return (
                                  <div
                                    key={comment.id}
                                    className="_comment_main d-flex flex-column mb-3"
                                  >
                                      ...
                                      <div className="_comment_area flex-grow-1 position-relative">
                                        <div className="_comment_details">
                                          ...
                                          <div
                                            ...
                                            onMouseEnter={() =>
                                              setHoveredLikesKey(`comment_${comment.id}`)
                                            }
                                            onMouseLeave={() => setHoveredLikesKey(null)}
                                          ...
                                          >
                                            ...
                                            {hoveredLikesKey === `comment_${comment.id}` &&
                                              comment.likedBy &&
                                    ...
                                    <div className="ps-5 border-start ms-3 mt-2">
                                      {comment.replies?.map((reply) => {
                                        const isReplyLiked =
                                          reply.isLiked ||
                                          reply.commentLikes?.some((l) => l.userId === user.id);
                                        const replyLikesCount =
                                          reply.likesCount ?? reply.commentLikes?.length ?? 0;

                                        return (
                                          <div
                                            key={reply.id}
                                            className="d-flex align-items-start mb-2 mt-2"
                                          >
                                            <div className="me-2">
                                              <img
                                                src="/assets/images/comment_img.png"
                                            ...
                                            <div className="_comment_area flex-grow-1 position-relative">
                                              <div className="_comment_details py-2 px-3 bg-light rounded shadow-sm">
                                                <h6
                                                  className="_comment_name_title fw-bold fs-7 mb-1"
                                                  style={{ fontSize: '12px' }}
                                                >
                                                ...
                                                <div
                                                  className="_total_reactions position-relative"
                                                  onMouseEnter={() =>
                                                    setHoveredLikesKey(`reply_${reply.id}`)
                                                  }
                                                  onMouseLeave={() => setHoveredLikesKey(null)}
                                                ...
                                                >
                                                  ...
                                                  {hoveredLikesKey === `reply_${reply.id}` &&
                                                    reply.likedBy &&
                                                ...
                                                <div
                                                  className="d-flex gap-2 list-unstyled mb-0 mt-1"
                                                ...
                                                >
                                                  <span
                                                    ...
                                                    style={{
                                                      cursor: 'pointer',
                                                      fontWeight: isReplyLiked ? 'bold' : 'normal',
                                                    }}
                                            ...
                                            <div className="_feed_inner_comment_box_content">
                                              ...
                                              <div className="_feed_inner_comment_box_content_txt">
                                                <input
                                                  ...
                                                  className="form-control _comment_inpt"
                                                  value={
                                                    commentTexts[`comment_${comment.id}`] || ''
                                                  }
                                                  onChange={(e) =>
                                                    setCommentTexts((prev) => ({
                                                      ...prev,
                                                      [`comment_${comment.id}`]: e.target.value,
                                                    }))
                                                  }
                                                />
                                              </div>
                ...
                <div className="_layout_right_sidebar_inner">
                  ...
                  <div className="_right_inner_area_info _padd_t24 _padd_b24 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                    <div className="_right_inner_area_info_content _mar_b24 d-flex justify-content-between align-items-center">
                      <h4 className="_right_inner_area_info_content_title _title5 m-0">
                        You Might Like
                      </h4>
                    ...
                    <div className="_right_inner_area_info_ppl mt-3">
                      <div className="_right_inner_area_info_box d-flex align-items-center mb-3">
                        ...
                        <div className="_right_inner_area_info_box_txt">
                          <h4 className="_right_inner_area_info_box_title fw-bold fs-7 mb-0">
                            Radovan SkillArena
                          </h4>
                          <p className="_right_inner_area_info_box_para text-muted mb-0 fs-8">
                      ...
                      <div className="_right_info_btn_grp d-flex gap-2">
                        <button
                          type="button"
                          className="_right_info_btn_link btn btn-light btn-sm flex-grow-1 py-1"
                        >
                          Ignore
                        </button>
                        <button
                          type="button"
                          className="_right_info_btn_link _right_info_btn_link_active btn btn-primary btn-sm flex-grow-1 py-1"
                        >
                          Follow
                        </button>
                      </div>
                  ...
                  <div className="_feed_right_inner_area_card _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area mt-4">
                    <div className="_feed_top_fixed">
                      <div className="_feed_right_inner_area_card_content _mar_b24 d-flex justify-content-between align-items-center">
                        <h4 className="_feed_right_inner_area_card_content_title _title5 m-0">
                          Your Friends
                        </h4>
                      ...
                      <div className="_feed_right_inner_area_card_ppl d-flex justify-content-between align-items-center mb-3">
                        <div className="_feed_right_inner_area_card_ppl_box d-flex align-items-center">
                          ...
                          <div className="_feed_right_inner_area_card_ppl_txt">
                            <h4 className="_feed_right_inner_area_card_ppl_title fw-bold fs-7 mb-0">
                              Steve Jobs
                            </h4>
                            <p className="_feed_right_inner_area_card_ppl_para text-muted mb-0 fs-8">
                              CEO of Apple
                            </p>
                          </div>
                        </div>
                        <div className="_feed_right_inner_area_card_ppl_side fs-9 text-muted">
                          5 min ago
                        </div>
                      </div>
                      <div className="_feed_right_inner_area_card_ppl d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <div className="_layout_mode_swithing_btn">
                        <button
                          ...
                          className="_layout_swithing_btn_link border-0 bg-transparent"
                        >
                          ...
                          <div className="_layout_change_btn_ic1">
                            ...
                            >
                              <path
                                fill="#fff"
                                d="M12.923 1.25a.625.625 0 01.109.704 7.5 7.5 0 0010.598 10.599.625.625 0 01.814.814 8.75 8.75 0 11-12.225-12.225.625.625 0 01.704.108zm-1.637 2.052A7.502 7.502 0 0018.04 18.04a7.503 7.503 0 00-6.753-14.738z"
                              />
                            </svg>
                          </div>
                          <div className="_layout_change_btn_ic2">
                            ...
                            >
                              <path
                                fill="#377DFF"
                                d="M10 13.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zm0-1.25a2.5 2.5 0 110-5 2.5 2.5 0 010 5zm0-8.75a.625.625 0 01.625.625v1.25a.625.625 0 11-1.25 0v-1.25A.625.625 0 0110 3.75zm0 11.25a.625.625 0 01.625.625v1.25a.625.625 0 11-1.25 0v-1.25a.625.625 0 01.625-.625zm6.25-6.25a.625.625 0 01.625-.625h1.25a.625.625 0 110 1.25h-1.25a.625.625 0 01-.625-.625zM2.5 8.75h1.25a.625.625 0 110 1.25H2.5a.625.625 0 110-1.25zm11.92-3.08a.625.625 0 01.884 0l.883.884a.625.625 0 11-.883.883l-.884-.883a.625.625 0 010-.884zM5.58 13.536a.625.625 0 01.884 0l.884.884a.625.625 0 11-.884.883l-.884-.883a.625.625 0 010-.884zm8.84 0a.625.625 0 010 .884l-.884.883a.625.625 0 11-.883-.883l.883-.884a.625.625 0 01.884 0zM5.58 5.67a.625.625 0 010-.884l.884-.883a.625.625 0 11.883.883l-.883.884a.625.625 0 01-.884 0z"
                              />
                            </svg>
                          </div>
                        </button>
