...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    alert("Google sign-in is not implemented. Please use standard email and password login.");
  };
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6 col-xl-6 col-md-6 col-sm-12">
                      <div className="_social_login_form_left">
                        <p className="_social_login_form_left_para" style={{ cursor: "pointer" }} onClick={() => alert("Forgot password functionality is not supported. Use standard credentials or register a new user.")}>
                          Forgot password?
                        </p>
                      </div>
                    </div>
